...
public class TrainTestGen {
	 ...
	 * @return
	 */
	public static Instances genTrain(Instances inss, int numFolds, int fold) {
		return inss.testCV(numFolds, fold);
	}
	 ...
	 * @return
	 */
	public static Instances genTest(Instances inss, int numFolds, int fold) {
		return inss.trainCV(numFolds, fold);
	}
